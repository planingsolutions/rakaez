        ...
        @endif
            <div class="row justify-content-center" style="margin-top: 10px;">
                <div class="col-12" style="margin:5%">
                            ...
                            <form action="{{route('admainpanal.aboutUpdate2',$data->id)}}" method="post" enctype="multipart/form-data" >
                                @csrf
                                    ...
                                    <div class="card-body p-3"style="direction: rtl; text-align:right;">
                                        <div class="form-group">
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="text" class="form-control" name="pargraph2" value="{{$data->pargraph1}}" title = "يجب ادخال النص" style="height:5rem;">   
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="text" class="form-control" name="pargraph3" value="{{$data->pargraph1}}" title = "يجب ادخال النص" style="height:5rem;">   
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="text" class="form-control" name="pargraph4" value="{{$data->pargraph1}}" title = "يجب ادخال النص" style="height:5rem;">   
                                            </div>
