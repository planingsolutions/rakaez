        ...
        @endif
            <div class="row justify-content-center" style="margin-top: 10px;">
                <div class="col-12" style="margin:5%">
                            ...
                            <form action="{{route('adminpanal.projectUpdate', $data->id)}}" method="post" enctype="multipart/form-data" >
                                @csrf
                                        ...
                                        <div class="card-body p-3"style="direction: rtl; text-align:right;">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="file" class="form-control" name="img" value="{{$data->img}}" title="هذا الحقل يقبل .jpg / .png /.jpeg">      
                                                </div>
